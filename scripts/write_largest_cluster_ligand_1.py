...
# TK: Fri Feb 17 16:08:54 ICT 2012
#     adding option to specify input dlg to analyse
import os, glob
...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print "         (1) read specified '.dlg' (or all the files with extension '.dlg') into one Docking"
        ...
        print "        [-l]    dlg file to analyze (or all '.dlg' in current directory)"
        print "        [-o pdbqt_filename] (default ligandstem-BC.pdbqt)"
        print "        [-v]    verbose output"

    # process command arguments
    try:
        opt_list, args = getopt.getopt(sys.argv[1:], 't:l:o:vh')
    ...
    if outputfilename is None:
        outputfilename = d.ligMol.name  + '-BC.pdbqt'
